...
export default function Dashboard() {
  ...
  <nav className="navbar">
    <ul className="nav-list">
      <li
        className={`nav-item dropdown ${isOpen ? 'active' : ''} ${activeContent === 'training' ? 'active' : ''}`}
        ref={dropdownRef}
      >
      ...
      <li className={`nav-item ${activeContentProsecution ? 'active' : ''}`} onClick={() => setActiveContent("prosecution")}>
        <Home /> Prosecution
      </li>

      <li className={`nav-item ${activeContentCourt ? 'active' : ''}`} onClick={() => setActiveContent("court")}>
        <CiMicrochip size={25} /> Court
      </li>

      <li className={`nav-item ${activeServices === 'correctionalservices' ? 'active' : ''}`} onClick={handleServicesClick}>
        <AiTwotoneThunderbolt /> Correctional Services
      </li>

      <li className={`nav-item ${activeContentScience ? 'active' : ''}`} onClick={() => setActiveContent("science")}>
