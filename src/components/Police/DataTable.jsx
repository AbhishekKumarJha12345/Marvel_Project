...
const TrainingDataDialog = ({ open, onClose, data, onSubmit, onEdit, selectTab }) => {
      ...
      {selectTab === "form" ? (
        <>
          ...
          <Table sx={{ minWidth: 650, border: "1px solid #ddd", borderRadius: "8px", overflow: "hidden" }}>
            <TableHead>
              <TableRow sx={{ backgroundColor: "#2d3748" }}>
                {["actAndSection_2", "registeredCases_2", "detectedCases_2", "detectedCasesPercentage_2"].map((key) => (
                  <TableCell
                    key={key}
                    sx={{
                      color: "white",
          ...
          <Table sx={{ minWidth: 650, border: "1px solid #ddd", borderRadius: "8px", overflow: "hidden" }}>
            <TableHead>
              <TableRow sx={{ backgroundColor: "#2d3748" }}>
                ...
                {["cases_registered", "cases_esakshya_used", "cases_esakshya_not_used","esakshya_usage_percent","esakshya_used_charge_sheeted","esakshya_not_used_invest"].map((key) => (
                  <TableCell
                    key={key}
                    sx={{
                      color: "white",
          ...
          {data?.map((tableData, tableIndex) => (
            <div key={tableIndex}>
              ...
              <Table sx={{ minWidth: 650, border: "1px solid #ddd", borderRadius: "8px", overflow: "hidden" }}>
                <TableHead>
                  <TableRow sx={{ backgroundColor: "#2d3748" }}>
                    {tableData.data[0]?.columns.map((col, colIndex) => (
                    ...
                    <TableRow key={rowIndex} sx={{ "&:nth-of-type(odd)": { backgroundColor: "#f5f5f5" } }}>
                      {row.columns.map((col, colIndex) => (
                        <TableCell key={colIndex} sx={{ padding: "4px", borderBottom: "1px solid #ddd", textAlign: "center", whiteSpace: "nowrap" }}>
                          {col.value === "" || col.value === null || col.value === undefined ? "-" : col.value}
                        </TableCell>
                      ))}
                    </TableRow>
                  ))}
