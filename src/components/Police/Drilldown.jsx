...
const DrilldownTrainingChart = () => {
  ...
  const trainingDataa = [
    {
      date: "2/11/2023",
      name: "Departmental Enquiry/ Primary Enquiry",
      mode: "Online",
      trainer: "Ram Kumar",
      totalRegistrations: 229,
      attendees: 23,
    },
    {
      date: "2/11/2023",
      name: "Training of Investigator on Women Safety (BPR&D New Delhi)",
      mode: "Online",
      trainer: "Suresh Sharma",
      totalRegistrations: 261,
      attendees: 65,
    },
    {
      date: "4/11/2023",
      name: "Training of Investigator on Women Safety",
      mode: "Offline",
      trainer: "Anjali Verma",
      totalRegistrations: 227,
      attendees: 76,
    },
    {
      date: "4/11/2023",
      name: "Sensitization of Police Officers on Atrocities against SC/ST and Investigation of Cases",
      mode: "Offline",
      trainer: "Pooja Singh",
    ...
    {
      date: "6/11/2023",
      name: "CDR, IPDR Mobile Related Crime and Mobile Forensic",
      mode: "Offline",
      trainer: "Rajesh Patel",
      totalRegistrations: 183,
      attendees: 54,
    },
    {
      date: "7/11/2023",
      name: "Investigation of NDPS Cases",
      mode: "Online",
      trainer: "Sunita Mehta",
      totalRegistrations: 367,
      attendees: 63,
    },
    {
      date: "9/11/2023",
      ...
      totalRegistrations: 444,
      attendees: 87,
    },
    {
      date: "9/11/2023",
      name: "Preventive Action and Externment Proceedings & MPDA",
      mode: "Online",
      trainer: "Neha Reddy",
    ...
    },
    {
      ...
      mode: "Online",
      trainer: "Alok Mishra",
      totalRegistrations: 379,
      attendees: 43,
    },
    {
      date: "13/11/2023",
      name: "Death in Custody and Custodial Violence",
      mode: "Online",
      trainer: "Deepa Nair",
      totalRegistrations: 167,
      attendees: 56,
    },
    {
      date: "13/11/2023",
      name: "Training of Prosecutors on Women Safety (BPR&D New Delhi)",
      mode: "Offline",
      trainer: "Manoj Tiwari",
      totalRegistrations: 145,
      attendees: 87,
    },
    {
      date: "13/11/2023",
      name: "Handling Law & Order and Use of Force",
      mode: "Online",
      trainer: "Kiran Desai",
    ...
    },
    {
      ...
      name: "Investigation of NDPS Cases",
      mode: "Offline",
      trainer: "Swati Saxena",
      totalRegistrations: 360,
      attendees: 54,
    },
    {
      date: "17/11/2023",
      name: "Investigation of Economic Crime Cases",
      mode: "Online",
      trainer: "Prakash Yadav",
      totalRegistrations: 185,
      attendees: 89,
    },
    {
      date: "17/11/2023",
      name: "Interrogation Skill",
      mode: "Offline",
      trainer: "Ritika Sen",
    ...
    {
      date: "20/11/2023",
      name: "OSINT and Social Media Analysis",
      mode: "Online",
      trainer: "Harish Gupta",
      totalRegistrations: 431,
      attendees: 234,
    },
    {
      date: "20/11/2023",
      name: "Gender Sensitization (BPR&D New Delhi)",
      mode: "Offline",
      trainer: "Meena Khatri",
      totalRegistrations: 93,
      attendees: 43,
    },
    {
      date: "20/11/2023",
      name: "Police Station Management",
      mode: "Online",
      trainer: "Arun Pillai",
      totalRegistrations: 477,
      attendees: 399,
    },
    {
      date: "24/11/2023",
      name: "Gender Sensitization (BPR&D New Delhi)",
      mode: "Offline",
      trainer: "Jyoti Chauhan",
      totalRegistrations: 453,
      attendees: 98,
    },
    {
      date: "24/11/2023",
      ...
      mode: "Offline",
      trainer: "Santosh Nair",
      totalRegistrations: 492,
      attendees: 90,
    },
    {
      date: "24/11/2023",
      ...
      mode: "Online",
      trainer: "Divya Kapoor",
      totalRegistrations: 306,
      attendees: 290,
    },
    {
      date: "24/11/2023",
      ...
      mode: "Online",
      trainer: "Ramesh Iyer",
      totalRegistrations: 206,
      attendees: 189,
    },
    {
      date: "30/11/2023",
      name: "Investigation of Cyber Crime Related to Social Media",
      mode: "Online",
      trainer: "Sneha Dutta",
      totalRegistrations: 231,
      attendees: 187,
    },
    {
      date: "30/11/2023",
      name: "Investigation of Bank Fraud Cases",
      mode: "Online",
      trainer: "Varun Saxena",
      totalRegistrations: 330,
      attendees: 267,
    },
    {
      date: "30/11/2023",
      name: "Departmental Enquiry/ Primary Enquiry",
      mode: "Online",
      trainer: "Nidhi Chauhan",
      totalRegistrations: 368,
      attendees: 254,
    },
    {
      date: "4/12/2023",
  ...
  // Loop through each training entry
  trainingDataa.forEach((entry) => {
    const key = entry.name; // Use name as the key

    // Initialize if not present
    if (!trainingCounts[key]) {
      trainingCounts[key] = {
        onlineRegistrations: 0,
        offlineRegistrations: 0,
        onlineAttendees: 0,
    ...
    // Accumulate data based on mode
    if (entry.mode === "Online") {
      trainingCounts[key].onlineRegistrations += entry.totalRegistrations;
      trainingCounts[key].onlineAttendees += entry.attendees;
    } else if (entry.mode === "Offline") {
      trainingCounts[key].offlineRegistrations += entry.totalRegistrations;
      trainingCounts[key].offlineAttendees += entry.attendees;
    }
  });

  // Populate data arrays
  Object.keys(trainingCounts).forEach((name) => {
    trainingNames.push(name);
    onlineRegistrations.push(trainingCounts[name].onlineRegistrations);
    offlineRegistrations.push(trainingCounts[name].offlineRegistrations);
    onlineAttendees.push(trainingCounts[name].onlineAttendees);
    offlineAttendees.push(trainingCounts[name].offlineAttendees);
  });
  ...
  //   labels: months, // Using training names instead of months
  //   datasets: [
  //     // {
  //     //   label: "Attended",
  //     //   data: onlineRegistrations,
  ...
  // Extract unique training names (to assign colors)
  const uniqueTrainingNames = [
    ...new Set(trainingDataa.map((item) => item.name)),
  ];

  // Assign colors dynamically
  const trainingColors = {};
  uniqueTrainingNames.forEach((name, index) => {
    trainingColors[name] = colorPalette[index % colorPalette.length]; // Cycle through colors
  });

  // Sort data by date (so the chart displays correctly)
  trainingDataa.sort((a, b) => new Date(a.date) - new Date(b.date));
  ...
  const handleTrainingSelection = (e) => {
    const trainingName = e.target.value;
    setSelectedTraining(trainingName);

    if (!selectedMonth) return; // Ensure selectedMonth exists

    // Extract month and year from selectedMonth
    const [selectedMonthValue, selectedYearValue] = selectedMonth
      .split("/")
      .map(Number);
  ...
  //     })
  //   : trainingDataa.filter((item) => item.mode === selectedMode); // Show overall month/year/mode data if no date is selected
  //   console.log('filteredTrainingData:',filteredTrainingData);
  ...
  const dateData = {
    ...
    datasets: [
      // Total Registrations Line
      {
        ...
        backgroundColor:
          selectedMode === "Online" ? chartColors[2] : chartColors[3],
        borderColor:
          selectedMode === "Online" ? chartColors[2] : chartColors[3],
        borderWidth: 2,
        tension: 0.4,
      ...
      // Total Attendees Line
      {
        ...
        backgroundColor:
          selectedMode === "Online" ? chartColors[0] : chartColors[1],
        borderColor:
          selectedMode === "Online" ? chartColors[0] : chartColors[1],
        borderWidth: 2,
        tension: 0.4,
  ...
  const handleMonthClick = (event, elements) => {
    if (elements.length > 0) {
      const dataIndex = elements[0].index; // Index of clicked bar
      const datasetLabel =
        trainingData.datasets[elements[0].datasetIndex].label; // Get label dynamically
  ...
  //   setView("sessions");
  // };
  const handleDateClick = (event, elements, chart) => {
    if (!elements.length) return;

    // Get the dataset index of the clicked element
    const datasetIndex = elements[0].datasetIndex;
    const datasetLabel = chart.data.datasets[datasetIndex].label;

    // Prevent click action if the label is "Pending"
    if (datasetLabel === "Pending") return;

    setSelectedDate("01"); // Replace with actual selected date
    setView("sessions");
  };
  // handleAttendedClick
  // const handleAttendedClick = (event, elements, chart) => {
  //   if (!elements.length) return;
  ...
  //   // Prevent click action if the label is "Pending"
  //   if (datasetLabel === "Registered") return;

  //   setSelectedDate("02"); // Replace with actual selected date
  //   setView("training");
  // };
  ...
  const handleAttendedClick = (event, elements, chart) => {
    ...
    // Get dataset label and training name
    const datasetLabel = chart.data.datasets[datasetIndex].label;
    const trainingName = chart.data.labels[index]; // Extract the clicked training name

    // Ensure the clicked label is "Attended" before proceeding
    if (datasetLabel !== "Attended") return;

    // Set the selected training name and update the view
    setSelectedTraining(trainingName);
    setView("training");
  };
  ...
  // ------------------------------
  const registeredCounts = [
    229, 261, 227, 83, 183, 367, 444, 88, 379, 167, 145, 234, 233, 360, 185,
    133, 431, 93, 477, 453, 492, 306, 206, 231, 330, 368, 271, 285, 90, 237,
    147, 69, 369, 70, 76, 448, 499, 316, 388, 43, 472, 196, 402, 230, 95, 470,
    156, 36, 404, 413, 168, 365, 432, 428, 219, 52, 265, 326, 242, 334, 244,
    412, 179, 376, 500, 159, 166, 304, 418, 264, 356, 203, 154, 223, 136, 47,
    56, 198, 481, 475, 443, 362, 75, 28, 204, 382, 235, 408, 401, 343, 62, 420,
    225, 192, 45, 361, 392, 337, 297, 494, 335, 176, 14, 427, 288, 447, 406, 11,
    352, 249, 91, 429, 342, 332, 395, 341, 97, 417, 479, 31, 377, 311, 452, 461,
    59, 48, 187, 381, 157, 301, 118, 282, 399, 148, 190, 490, 217, 284, 131, 87,
    462, 73, 40, 489, 435, 44, 273, 254, 54, 123, 144, 338, 262, 439, 272, 32,
    177, 10, 260, 314, 39, 269, 37, 296, 454, 98, 12, 410, 213, 188, 389, 49,
    241, 245, 46, 263, 473, 460, 355, 171, 308, 442, 74, 277, 60, 327, 182, 38,
    92, 426, 445, 409, 268, 109, 58, 305, 216, 486, 79, 255, 347, 496, 394, 155,
    484, 111, 321, 55, 346, 493, 466, 407, 487, 9, 390, 247, 383, 199, 398, 354,
    387, 15, 42, 309,
  ];
  const attendedCounts = [
    23, 65, 76, 54, 54, 303, 87, 81, 43, 56, 87, 98, 90, 54, 89, 90, 234, 43,
    399, 98, 90, 290, 189, 187, 267, 254, 65, 89, 67, 201, 111, 13, 310, 23, 25,
    410, 409, 199, 100, 34, 410, 99, 201, 201, 10, 401, 140, 19, 202, 199, 100,
    34, 410, 99, 201, 43, 100, 301, 140, 199, 202, 400, 19, 100, 301, 140, 19,
    202, 400, 199, 98, 45, 87, 87, 89, 41, 20, 99, 56, 87, 98, 75, 32, 14, 100,
    109, 209, 400, 299, 341, 60, 410, 201, 187, 41, 309, 310, 310, 291, 490,
    330, 167, 11, 410, 210, 410, 389, 10, 340, 201, 76, 410, 309, 330, 378, 330,
    34, 409, 418, 29, 87, 89, 51, 410, 55, 44, 18, 290, 154, 300, 109, 281, 310,
    140, 180, 410, 210, 210, 110, 85, 409, 71, 20, 409, 48, 41, 75, 89, 9, 110,
    121, 190, 209, 410, 218, 13, 109, 7, 29, 311, 13, 193, 21, 244, 379, 82, 8,
    313, 178, 116, 298, 21, 188, 184, 31, 208, 367, 388, 265, 116, 273, 428, 63,
    214, 25, 310, 144, 25, 70, 380, 356, 376, 186, 79, 36, 286, 167, 413, 44,
    195, 267, 410, 298, 135, 386, 78, 266, 32, 289, 416, 392, 356, 416, 6, 301,
    183, 289, 157, 328, 313, 334, 13, 30, 281,
  ];

  const remainingCounts = registeredCounts.map(
    (reg, i) => reg - attendedCounts[i]
  );
  ...
  // ClearTrainingFilter
  const ClearTrainingFilter = (type) => {
    console.log("type", type);
