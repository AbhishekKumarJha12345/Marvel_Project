...
const PoliceOfficers = () => {
  ...
  const data = {
    labels: [
      trainingData ? trainingData[0].rank : "",
      trainingData ? trainingData[1].rank : "",
    ], // Labels for the two roles
    datasets: [
      {
        label: "Available Officers",
        data: [
          trainingData ? trainingData[0].available_officers : "",
          trainingData ? trainingData[0].trained_officers : "",
        ], // Available Officers for AP and TS
      ...
      },
      {
        ...
        data: [
          trainingData ? trainingData[1].available_officers : "",
          trainingData ? trainingData[1].trained_officers : "",
        ], // Total Trained Officers for AP and TS
      ...
      tooltip: {
        callbacks: {
          ...
          label: function (tooltipItem) {
            ...
            if (dataIndex === 0) {
              // Police Officers(PSI to SP/DCP) group
              percentage = "92.35%"; // Percentage for Police Officers group
            } else if (dataIndex === 1) {
              // Police Personnel(PC to ASI) group
  ...
  return (
    <div className="flex space-x-4">
      <div className="w-1/2 bg-white p-6 rounded-lg h-[500px] text-center">
        <div className="flex justify-between items-center mb-8">
          <h1 className="text-xl font-bold">Police Officers</h1>
          <button
