...
export default function Dashboard({ users }) {
  ...
  const contentMap = {
    training: (
      <div className="content">
        <div className="ContentSpace">
          ...
          <button className="ExportButton" onClick={handleExportPoliceTraining}>
            Export
          </button>
        </div>
    ...
    court: (
      <div className="content">
        ...
        {/* <div className="ContentSpace">
          <h1 className="heading">Court Visits</h1>
          <button className="ExportButton" onClick={handleExportCourt}>
            Export
          </button>
        </div> */}
        <Dashboard2/>
  ...
  const generatePDF = () => {
    ...
    doc.text(
      "In the provided data, there are two sets of statistics related to court cases for the months September 2021 and February 2025:",
      10,
      110,
      { maxWidth: 190 }
    );
    doc.text(
      "- Total charge-sheeted: Both months have a total of 7 charges sheeted, but it's not clear if this is the same set of cases or different ones.",
      10,
      130,
      { maxWidth: 190 }
    );
    doc.text(
      "- Pending Cases: In September 2021, there were 432 pending cases, while in February 2025, there were 7 pending cases.",
      10,
      150,
      { maxWidth: 190 }
    );
    doc.text(
      "- Acquittals: In September 2021, there were 44 acquitted cases, while in February 2025, there were 7 acquitted cases.",
      10,
      170,
      { maxWidth: 190 }
    );
    doc.text(
      "- Convictions: In September 2021, there were 233 convicted cases, while in February 2025, there were only 7 convicted cases.",
      10,
      190,
      { maxWidth: 190 }
    );
    doc.text(
      "- In summary, it appears that there has been a significant reduction in the number of pending, acquitted, and convicted cases from September 2021 to February 2025.",
      10,
      210,
      { maxWidth: 190 }
    );
    ...
    doc.text(
      "Analysis of Forensic Department Performance from July 2024 to January 2025 Over the six months analyzed, the forensic department exhibited some notable trends in case and exhibit disposal, intake, and pending status.",
      10,
      110,
      { maxWidth: 190 }
    );
    ...
    doc.text(
      "- Pending cases: Peaked in August 2024 (186,321), steadily decreased to January 2025 (183,394).",
      10,
      150,
      { maxWidth: 190 }
    );
    doc.text(
      "- Received cases: Highest intake in December 2024 (25,258), lowest in July 2024 (22,211).",
      10,
      160,
      { maxWidth: 190 }
    );
    ...
    doc.text(
      "- Pending exhibits: Peaked in August 2024 (6,65,143), declined to January 2025 (6,74,863).",
      10,
      180,
      { maxWidth: 190 }
    );
    doc.text(
      "- Received exhibits: Highest in December 2024 (53,470), lowest in July 2024 (49,066).",
      10,
      190,
      { maxWidth: 190 }
    );
    doc.text(
      "- Overall Trends: Increasing pending cases despite fluctuations suggests a processing bottleneck.",
      10,
      200,
      { maxWidth: 190 }
    );
    doc.text(
      "  Consider increasing staffing levels, streamlining procedures, and prioritizing high-impact cases.",
      10,
      210,
      { maxWidth: 190 }
    );
    ...
    <div className="dashboard">
      ...
      {users === "chief secretary"
        ? contentMap[activeSection?.section] || (
            ...
            >
              <h2 style={{ fontSize: "29px", fontWeight: "500" }}>
                ICJS-Interoperable Criminal Justice System
              </h2>
              <p style={{ fontSize: "18px" }}>
                MAHARASHTRA RESEARCH & VIGILANCE MARVEL FOR ENHANCED LAW
                ENFORCEMENT LIMITED
              </p>
